...
const views: Record<LaptopVariant, {
  ...
  overview: {
    title: "Good morning",
    eyebrow: "Overview",
    subtitle: "Here is what is happening with Demo workspace.",
  ...
  queue: {
    ...
    eyebrow: "Content",
    subtitle: "Manage and review Demo workspace drafts before publishing.",
        ...
        <div className="laptop-screen">
          ...
          <div className="mini-app">
            <div className="mini-top">
              ...
              <span className="mini-project"><b>DW</b>Demo workspace</span>
            ...
            <div className={`mini-content-grid${variant === "queue" ? " mini-content-grid--queue" : ""}`}>
              ...
              {variant !== "queue" && <div className="mini-opportunities">
                ...
                <div className="mini-health"><b>Workspace health</b><strong>● Healthy</strong><small>Demo workspace preview</small></div>
              </div>}
            </div>
            ...
            <div className="mini-screen-footer"><span>Demo workspace</span><span>Illustrative product preview</span><span>May 2025</span></div>
          </div>
        </div>
      </div>
