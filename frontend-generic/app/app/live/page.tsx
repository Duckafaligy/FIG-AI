    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      >
        ...
        >
          ...
          <dd style={{ margin: 0, minWidth: 0, overflowWrap: "anywhere", fontFamily: "ui-monospace, monospace" }}>{apiUrl("/api")}</dd>
          ...
          <dd style={{ margin: 0, minWidth: 0, overflowWrap: "anywhere" }}>{workspace || "—"}</dd>
