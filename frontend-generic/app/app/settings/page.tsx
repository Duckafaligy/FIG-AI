  ...
  return <>
    ...
    <div className="settings-tabbed-workbench">
      <aside className="settings-tab-sidebar" aria-label="Settings sections">
        <div className="settings-sidebar-workspace"><span className="settings-workspace-mark">DW</span><div><strong>Demo workspace</strong><small>Frontend preview</small></div><ChevronRight size={15} /></div>
      ...
      <section className="settings-tab-content" role="tabpanel" id={panelId(activeTab)} aria-labelledby={tabId(activeTab)}>
        <header className="settings-tab-header"><span className="settings-tab-icon"><ActiveIcon size={19} /></span><div><h2>{active.label}</h2><p>{active.description}</p></div><span className="settings-demo-chip"><span />Frontend demo</span></header>

        {activeTab === "workspace" && <div className="settings-tab-stack">
          <section className="settings-surface settings-workspace-surface"><div className="settings-surface-heading"><div><h3>Workspace profile</h3><p>The core details shown throughout this frontend preview.</p></div><PreviewInfo className="settings-link-button" label="Edit profile" message="Workspace editing is disabled in this frontend preview. No change is sent to Demo workspace, Supabase, or any connected service." /></div><div className="settings-workspace-profile"><span className="settings-profile-logo">DW</span><div><strong>Demo workspace</strong><p>Plain-English AI lessons, prompts, courses, and practical workflows.</p><span><BadgeCheck size={13} />Preview workspace</span></div></div><div className="settings-fact-grid"><article><span>Workspace ID</span><strong>demo_workspace_01</strong></article><article><span>Owner</span><strong>Jordan Davis</strong></article><article><span>Industry</span><strong>Education & technology</strong></article><article><span>Timezone</span><strong>Eastern Time</strong></article><article><span>Website</span><strong>demo-workspace.example</strong></article><article><span>Created</span><strong>Sep 13, 2026</strong></article></div></section>
