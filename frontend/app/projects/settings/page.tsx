...
export default function WorkspaceSettingsPage() {
  ...
  return <>
    <DashboardHeader eyebrow="Settings" title="Workspace settings" description="Account-wide: workspace profile, team access, and billing. A project's own connectors live on that project's Settings tab." action="Edit profile" />
