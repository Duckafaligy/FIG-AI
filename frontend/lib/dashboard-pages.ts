...
export const dashboardPages: Record<string, DashboardPage> = {
  overview: {
    ...
    description: "Track blog performance, SEO, GEO, and content impact for LaunchVault.ca.",
    nav: "Overview",
    action: "New content",
    metrics: [
    ...
    sections: [
      ...
      },
      {
        ...
        description: "LaunchVault visibility across traditional and answer engines.",
        icon: Target,
        kind: "summary",
        span: "third",
        meta: "Last 30 days",
      ...
      },
      {
        ...
        description: "Best-performing LaunchVault learning content this reporting period.",
        icon: Trophy,
        kind: "table",
        variant: "ranked",
        span: "half",
      ...
      },
      {
        ...
        description: "The latest actions inside the LaunchVault workspace.",
        icon: Activity,
        kind: "feed",
        span: "third",
        meta: "View all →",
        rows: [
          ...
          { title: "CMS sync completed", meta: "3 LaunchVault pages updated", status: "1d ago", tone: "green" }
        ]
      },
      {
        area: "overview-keywords",
        title: "Top Ranking Keywords",
        description: "Keyword movement for LaunchVault.ca across tracked search terms.",
        icon: Search,
        kind: "table",
        variant: "ranked",
        span: "third",
      ...
      },
      {
        ...
        description: "Published LaunchVault content, ordered by the most recent update.",
        icon: Database,
        kind: "table",
        variant: "library",
        span: "two-thirds",
      ...
      },
      {
        ...
        description: "Connection and workflow readiness for LaunchVault.ca.",
        icon: ShieldCheck,
        kind: "health",
        span: "third",
  ...
  seo: {
    ...
    description: "Create, optimize, review, and publish search-ready content for LaunchVault.ca.",
    nav: "SEO",
    action: "Create brief",
    metrics: [
    ...
    sections: [
      {
        ...
        description: "From idea to impact—how a LaunchVault SEO brief becomes published content.",
        icon: Workflow,
        kind: "flow",
        span: "two-thirds",
        meta: "How it works",
        steps: [
          { label: "Connected project", copy: "LaunchVault topics and library" },
      ...
      },
      {
        ...
        rows: [
          ...
          { title: "LaunchVault voice", meta: "Plain English · Beginner friendly", status: "Applied", tone: "purple" }
        ]
      },
      {
        area: "seo-review",
        title: "Blog Posts for Review",
        description: "Editorial queue for the single LaunchVault project.",
        icon: ListChecks,
        kind: "table",
        variant: "library",
        span: "wide",
      ...
      },
      {
        area: "seo-impact",
        title: "Highest Impact Blog Posts",
        description: "LaunchVault content with the strongest search performance.",
        icon: Trophy,
        kind: "table",
        variant: "ranked",
        span: "third",
      ...
      },
      {
        ...
        description: "Keyword movement across LaunchVault topic clusters.",
        icon: ChartNoAxesCombined,
        kind: "chart",
        chart: "bars",
        span: "third",
      ...
      },
      {
        ...
        description: "Connections between LaunchVault courses, topics, and practical guides.",
        icon: Link2,
        kind: "table",
        span: "third",
        meta: "View all →",
      ...
      },
      {
        ...
        description: "Published LaunchVault pages with traffic and SEO scores.",
        icon: Database,
        kind: "table",
        variant: "library",
        span: "two-thirds",
      ...
      },
      {
        ...
        description: "Coverage across LaunchVault's core AI learning categories.",
        icon: Network,
        kind: "chart",
        chart: "donut",
        span: "half",
      ...
      },
      {
        ...
        description: "A focused quality summary for the LaunchVault content library.",
        icon: ShieldCheck,
        kind: "health",
        span: "half",
        meta: "View details",
  ...
  geo: {
    ...
    description: "Track how LaunchVault appears in generative AI search and improve answer inclusion.",
    nav: "GEO",
    action: "Add query",
    metrics: [
    ...
    sections: [
      {
        ...
        description: "The GEO workflow used to structure, review, publish, and monitor LaunchVault content.",
        icon: Sparkles,
        kind: "flow",
        span: "wide",
        meta: "GEO workflow",
        steps: [
          { label: "Connected project", copy: "LaunchVault library context" },
      ...
      },
      {
        ...
        description: "A representative answer preview for a LaunchVault discovery query.",
        icon: Bot,
        kind: "answer",
        span: "half",
        meta: "Try another query",
        rows: [
          { title: "What is the easiest way to start learning AI?", meta: "LaunchVault offers short, plain-English AI lessons, practical workflows, and copy-ready prompts designed to help beginners build useful skills without technical jargon.", status: "Good", tone: "green", kicker: "AI OVERVIEW" },
          { title: "LaunchVault.ca", meta: "Primary owned source", status: "#1", tone: "purple" },
      ...
      },
      {
        ...
        description: "LaunchVault pages structured for clear, citeable answers.",
        icon: FileCheck2,
        kind: "table",
        variant: "library",
        span: "wide",
      ...
      },
      {
        ...
        description: "Answer inclusion by common LaunchVault discovery intent.",
        icon: Network,
        kind: "table",
        variant: "ranked",
        span: "third",
      ...
      },
      {
        ...
        description: "Sampled queries and how clearly the LaunchVault answer appears.",
      ...
      },
      {
        ...
        description: "Citation distribution by LaunchVault content type.",
        icon: Database,
        kind: "chart",
        chart: "donut",
        span: "third",
    ...
    sections: [
      {
        ...
        description: "LaunchVault alerts ordered from newest to oldest.",
        icon: Bell,
        kind: "feed",
        span: "two-thirds",
        meta: "Most recent",
        ...
        rows: [
          ...
          { title: "Content sync retry scheduled", meta: "LaunchVault library sync · 5 hours ago", status: "Resolve", category: "Syncs", tone: "red" },
      ...
      },
      {
        ...
        description: "Reliability across the core LaunchVault workflow.",
        icon: Workflow,
        kind: "chart",
        chart: "reliability",
        span: "third",
      ...
      },
      {
        ...
        description: "The next LaunchVault publishing events.",
        icon: CalendarCheck2,
        kind: "feed",
        span: "third",
        meta: "View all →",
      ...
      },
      {
        ...
        description: "Content waiting for a LaunchVault review decision.",
        icon: Users,
        kind: "feed",
        span: "third",
        meta: "View all →",
  ...
  history: {
    ...
    sections: [
      ...
      },
      {
        ...
        description: "The latest workspace actions for LaunchVault.ca.",
        icon: History,
        kind: "feed",
        span: "half",
        meta: "View all →",
      ...
      },
      {
        ...
        rows: [
          ...
          { title: "LaunchVault AI", meta: "428 actions", status: "29%", tone: "blue", rank: 2 },
      ...
      },
      {
        ...
        description: "Complete history of LaunchVault workspace actions.",
        icon: ListChecks,
        kind: "table",
        variant: "audit",
        span: "wide",
        ...
        rows: [
          ...
          { date: "May 25, 2025 9:47 AM", category: "Sync", title: "Content library data synced", meta: "LaunchVault library (24 items)", actor: "System", status: "Success", tone: "green" },
          { date: "May 25, 2025 8:31 AM", category: "Automation", title: "Internal linking suggestions completed", meta: "5 blog posts", actor: "LaunchVault AI", status: "Success", tone: "green" },
          ...
          { date: "May 24, 2025 11:08 AM", category: "GEO", title: "Updated AI search visibility settings", meta: "Site-wide", actor: "LaunchVault AI", status: "Success", tone: "green" }
      ...
      },
      {
        ...
        meta: "Recent",
        rows: [
          { title: "May 25 · 10:24 AM", meta: "One LaunchVault item", status: "Success", tone: "green" },
          { title: "May 24 · 4:12 PM", meta: "Three LaunchVault items", status: "Success", tone: "green" },
