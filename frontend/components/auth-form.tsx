  ...
  return (
    <form className={`auth-form auth-form--${mode}`} onSubmit={submit}>
      ...
      <div className="auth-fields">
        {signup && <label className="auth-field" htmlFor="full-name"><span>Full name</span><input id="full-name" required autoComplete="name" placeholder="LaunchVault team" /></label>}
        ...
        {signup && <label className="auth-field" htmlFor="company"><span>Company name</span><input id="company" required autoComplete="organization" placeholder="LaunchVault" /></label>}
        {signup && <label className="auth-field" htmlFor="website"><span>Website URL</span><input id="website" required type="url" placeholder="https://launchvault.ca" /></label>}
